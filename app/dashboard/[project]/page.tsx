...
import DatabasePage from "../../database-edtior/database";
import FrontendPage from "../../frontend-editor/frontend";
...
export default function ProjectPage() {
  ...
  <div className="flex flex-col h-screen">
    <div className="flex gap-2 backdrop-blur-lg relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-gradient-to-l after:from-gray-200/80 after:to-gray-500">
