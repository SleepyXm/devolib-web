...
SERVICE_ROWS = [
    {
        ...
        "default_port": 5173,
        "scaffold_command": "create-vite {name} --template react",
    ...
    },
    {
        ...
        "default_port": 3000,
        "scaffold_command": "create-next-app {name} --typescript --tailwind --eslint --app --src-dir --use-npm --yes",
    ...
    },
    {
        ...
        "default_start_command": "npm run dev -- --host 0.0.0.0",
        "default_port": 5173,
        "scaffold_command": "create-vite {name} --template vue",
        "start_flags": "--host 0.0.0.0",
        "default_packages": "[]",
    },
    {
        ...
        "default_start_command": "npm run dev -- --host 0.0.0.0",
        "default_port": 5173,
        "scaffold_command": "create-vite {name} --template vanilla",
        "start_flags": "--host 0.0.0.0",
        "default_packages": "[]",
    },
    {
